...
void PMS_display(void)
{
	...
	/*
	// rectangle
	//glBegin(PC_RECTANGLE);
	glBegin(GL_POLYGON);
	//glRotatef(10.0f,1.0f,0.0f,-2.0f);
	glColor3f(1.0f, 0.0f, 0.0f);
	glVertex2f(2.0f, 0.0f);  // left bottom vertex

	glColor3f(0.0f, 1.0f, 0.0f);
	glVertex2f(4.0f, 0.0f);  // right bottom vertex

	glColor3f(0.0f, 0.0f, 1.0f);
	glVertex2f(4.0f, 2.0f);  // right top vertex
	
	glColor3f(1.0f, 1.0f, 1.0f);
	glVertex2f(2.0f, 2.0f);  // left top vertex
	glEnd();
